        ...
        <form className='px-2 mt-8'>
            ...
            <div className='flex flex-col w-full'>
                <p className='font-semibold'>Delivery Information</p>
                    ...
                    <input type="text" placeholder='First name' className='border-2 border-gray-200 rounded-md p-1 mb-1' name="" id="" />
                    <input type="text" placeholder='Last name' className='border-2 border-gray-200 rounded-md p-1 mb-1' name="" id="" />
                
                
                    <input type="email" placeholder='email' className='border-2 border-gray-200 rounded-md p-1 mb-1' name="" id="" />
                    <input type="text" placeholder='City' className='border-2 border-gray-200 rounded-md p-1 mb-1' name="" id="" />
                    <input type="text" placeholder='Street' className='border-2 border-gray-200 rounded-md p-1 mb-1' name="" id="" />
